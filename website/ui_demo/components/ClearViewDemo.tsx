...
import { PredictResponse, ExplanationResponse } from "@/types";
...
export default function ClearViewDemo() {
  ...
  // Predict State
  const [text, setText] = useState("The product arrived on time and the packaging was great, but the quality is terrible for the price.");
